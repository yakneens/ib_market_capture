...
def parse_args():
    ...
    help_str = "Can't get timestamp flag."
    my_parser.add_argument("-t", "--cant_get_timestamp", dest="cant_get_timestamp",
                           help=help_str,
                           choices=['true', 'false'],
                           required=True)
    help_str = "Date order."
...
def main(args):
    ...
    last_load = args.last_load
    cant_get_timestamp = args.cant_get_timestamp
